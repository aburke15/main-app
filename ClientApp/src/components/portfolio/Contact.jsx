                ...
                <Grid>
                    <Row className="contact-margin contact-top-row">
                        <h4 className="text-center">
                            <a className="contact-email" href="mailto:aburkex24@gmail.com" target="_top" rel="noopener">
                    ...
                    <Row>
                        <div className="text-center">
                            <a className="contact-icon-space" href="https://www.linkedin.com/in/aburkex24" target="_blank" rel="noopener">
                                <img className="contact-icon" src="../img/portfolio/linkedin.png" />
                            </a>
                            <a className="contact-icon-space" href="https://www.youtube.com/channel/UCczcmJfcsvhmW-65r1RuZ4w/featured?view_as=subscriber" target="_blank" rel="noopener">
                                <img className="contact-icon" src="../img/portfolio/youtube.png" />
                            </a>
                            <a className="contact-icon-space" href="https://github.com/aburkex24" target="_blank" rel="noopener">
